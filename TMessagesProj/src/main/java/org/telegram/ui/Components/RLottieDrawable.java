...
public class RLottieDrawable extends BitmapDrawable implements Animatable, BitmapsCache.Cacheable {
    ...
    public RLottieDrawable(File file, int w, int h, BitmapsCache.CacheOptions options, boolean limitFps, int[] colorReplacement, int fitzModifier) {
        this(file, null, w, h, options, limitFps, colorReplacement, fitzModifier, false);
    }
